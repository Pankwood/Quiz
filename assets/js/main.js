...
(function ($) {
	...
	if (localStorage.getItem("numCorrect") >= 2)
		$('#recompensa2').removeClass('blur');
	if (localStorage.getItem("numCorrect") >= 3)
		$('#recompensa3').removeClass('blur');
	if (localStorage.getItem("numCorrect") >= 4)
