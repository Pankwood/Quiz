    ...
    for (let i = 0; i < questionNumber; i++) {
      ...
      if (i === 0) {
        for (let j = 0; j < Object.keys(value.Questions.question0).length; j++) {
          ...
          if (value.Questions?.question0[j].check === "true")
            value.Questions[i].correctAnswer = value.Questions?.question0[j].answer;
        }
      }
      else if (i === 1) {
        for (let j = 0; j < Object.keys(value.Questions.question1).length; j++) {
          ...
          if (value.Questions?.question1[j].check === "true")
            value.Questions[i].correctAnswer = value.Questions?.question1[j].answer;
        }
      }
      else if (i === 2) {
        for (let j = 0; j < Object.keys(value.Questions?.question2).length; j++) {
          ...
          if (value.Questions?.question2[j].check === "true")
            value.Questions[i].correctAnswer = value.Questions?.question2[j].answer;
        }
      }
      else if (i === 3) {
        for (let j = 0; j < Object.keys(value.Questions?.question3).length; j++) {
          ...
          if (value.Questions?.question3[j].check === "true")
            value.Questions[i].correctAnswer = value.Questions?.question3[j].answer;
        }
      }
      else if (i === 4) {
        for (let j = 0; j < Object.keys(value.Questions?.question4).length; j++) {
          ...
          if (value.Questions?.question4[j].check === "true")
            value.Questions[i].correctAnswer = value.Questions?.question4[j].answer;
        }
      }
